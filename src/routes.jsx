...
const Report = lazy(() =>
  import("@/pages").then((m) => ({ default: m.Report })),
);
const Ranking = lazy(() =>
  import("@/pages").then((m) => ({ default: m.Ranking })),
);
...
const MyPage = lazy(() =>
  import("@/pages").then((m) => ({ default: m.MyPage })),
);
const MyReports = lazy(() =>
  import("@/pages").then((m) => ({ default: m.MyReports })),
);
...
const withSuspense = (Component) => (
  <Suspense
    fallback={<LoadingSpinner text="페이지를 불러오는 중입니다... 🚀" />}
  >
    <Component />
  </Suspense>
);
