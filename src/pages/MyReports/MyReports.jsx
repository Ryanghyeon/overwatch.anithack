...
export function MyReports() {
    ...
    if (isAuthLoading || loading) return <div className="reports-wrapper"><div className="reports-loading">데이터를 불러오는 중... 🏃‍♂️💨</div></div>;
                ...
                <div className="reports-list">
                    {reports.length === 0 ? (
                        <div className="empty-reports">
                            ...
                            <p>아직 신고한 내역이 없습니다.</p>
                            <button className="btn-go-report" onClick={() => navigate('/report')}>
                                신고하러 가기
                            </button>
                        </div>
                    ) : (
